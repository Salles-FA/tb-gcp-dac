...
def call_jenkins(git_repo_url):
    ...
    # TODO this is a hard-coded jenkins server! just for demo, remove after
    call_string = "curl -X POST http://remote_user:11eccd7308d0e2f408e53f04b16c839e65@34.89.62.54:8080/job/Activator%20Deploy/build?token=11eccd7308d0e2f408e53f04b16c839e65"
    call_process(call_string)
